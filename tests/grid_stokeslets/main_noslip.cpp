...
vector force(int i, int j, double x[N][N], double y[N][N]) {
  ...
  if (dlk_00 == 0.0f) { f_00.x = 0.0f; f_00.y = 0.0f; }
	...
	//t_00 = atan2f(-y[i_1][j_1]+y[i_0][j_0], x[i_1][j_1]-x[i_0][j_0]);
	//f_00.x = -1.0f*ks*cosf(t_00)*(dlk_00-rd);
        //f_00.y = 1.0f*ks*sinf(t_00)*(dlk_00-rd);	 
  ...
  if (dlk_20 == 0.0f) { f_20.x = 0.0f; f_20.y = 0.0f; }
	...
	//t_20 = atan2f(-y[i_1][j_1]+y[i_2][j_0], x[i_1][j_1]-x[i_2][j_0]);
	//f_20.x = -1.0f*ks*cosf(t_20)*(dlk_20-rd);
        //f_20.y = 1.0f*ks*sinf(t_20)*(dlk_20-rd);
  ...
  if (dlk_02 == 0.0f) { f_02.x = 0.0f; f_02.y = 0.0f; }
	...
	//t_02 = atan2f(-y[i_1][j_1]+y[i_0][j_2], x[i_1][j_1]-x[i_0][j_2]);
	//f_02.x = -1.0f*ks*cosf(t_02)*(dlk_02-rd);
        //f_02.y = 1.0f*ks*sinf(t_02)*(dlk_02-rd);
  ...
  if (dlk_22 == 0.0f) { f_22.x = 0.0f; f_22.y = 0.0f; }
        ...
        //t_22 = atan2f(-y[i_1][j_1]+y[i_2][j_2], x[i_1][j_1]-x[i_2][j_2]);
	//f_22.x = -1.0f*ks*cosf(t_22)*(dlk_22-rd);
        //f_22.y = 1.0f*ks*sinf(t_22)*(dlk_22-rd);
...
double pressure(int i, int j, double x[N][N], double y[N][N]) {
  ...
  for (int jj=0; jj<N; jj++) { // loop over all nodes in the grid
    for (int ii=0; ii<N; ii++) { 
  	f.x = force(ii, jj, x, y).x;
        f.y = force(ii, jj, x, y).y;
